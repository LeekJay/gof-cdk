...
import { generateSignedObject } from './utils';
...
async function test() {
    ...
    const data = generateSignedObject({ fid: '38794697', time: Date.now() }, 'Uiv#87#SPan.ECsp');
    ...
    const giftData = generateSignedObject({ fid: '38794697', cdk: 'HAPPY61', captcha_code: captchaResult, time: Date.now() }, 'Uiv#87#SPan.ECsp');
